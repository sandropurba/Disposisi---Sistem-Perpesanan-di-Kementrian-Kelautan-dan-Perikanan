...
?>
<html>
<head><title>Tampil Lanjut Kasubdit Penyidikan</title>
</head>
<body>
<div style="margin-bottom:15px;" align="right">
		<form action="barbuk.php?menu=search7&amp;act=search" method="post" name="formcari">
...
<h1 align="center" class="style1"><span class="style3">Tampil Lanjut Kasubdit Penyidikan</h1>
<?php
date_default_timezone_set("Asia/Jakarta");
include "koneksi.php";
$perihal_surat= $_POST['perihal_surat']; //get the nama value from form
$q = "SELECT * from kabidblanjut where perihal_surat like '%$perihal_surat%' "; //query to get the search result
