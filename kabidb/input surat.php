...
<body>
<div align="center">
<form action="ktu.php?menu=penyidikan&amp;act=tambahberita" method="post" enctype="multipart/form-data" name="frminput">
<div id="atas">Input Surat Kasubdit Penyidikan</div>
...
<td>:</td><td><input type="text" name="ttujuan" size="39" Value="Kasubdit Penyidikan"></td>
</tr>
<tr>
<td></td><td></td>
<td>&nbsp;&nbsp;
